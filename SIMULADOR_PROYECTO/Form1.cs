    ...
    public partial class Form1 : Form
    {
        ...
        private void TimerCola_Tick_1(object sender, EventArgs e)
        {
            ...
            if (colaProcesos.Count < 10)
            {
                ...
                if (MemoriaUtilizada + mb <= 400)
                {
                    // Crear un nuevo nombre de proceso con el tamaño 
                    ...
                    // Guardar el proceso en el diccionario usando el ID único como clave
        ...
        private void ActualizarMemoria()
        {
            ...
            memoriaDisponible = 400 - memoriaUsada;
